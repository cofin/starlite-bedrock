...
from starlite_bedrock.repository import (  # noqa: TC002
    BeforeAfter,
    CollectionFilter,
    LimitOffset,
)
...
class Filters:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            "id_filter": self.id,
            "created_at_filter": self.created_at,
            "updated_at_filter": self.updated_at,
...
def filters(
    ...
    created_at_filter: BeforeAfter | None = Dependency(),
    updated_at_filter: BeforeAfter | None = Dependency(),
    ...
    -------
    Filters
        Data structure that aggregates collection query filters.
    """
    return Filters(
        id=id_filter,
