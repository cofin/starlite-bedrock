...
"""
OpenAPI config for app, see [OpenAPISettings][starlite.contrib.bedrock.config.OpenAPISettings]

Default to 'elements' for the documentation. It has an interactive 3.1 compliant web app and Swagger does not yet support 3.1
"""
