...
from starlite_bedrock.starlite.filter_parameters import (
    created_filter,
    id_filter,
    limit_offset_pagination,
    updated_filter,
)
from starlite_bedrock.starlite.guards import CheckPayloadMismatch
...
class get_collection(handlers.http.get):  # pylint: disable=[invalid-name]
    """
    ...
    def __init__(
        ...
        dependencies.update({k: Provide(v) for k, v in default_dependencies if k not in dependencies})
        super().__init__(
            path=path,
...
# noinspection PyPep8Naming
class put(handlers.http.put):  # pylint: disable=[invalid-name]
    """
...
# noinspection PyPep8Naming
class patch(handlers.http.patch):  # pylint: disable=[invalid-name]
    """
...
# noinspection PyPep8Naming
class delete(handlers.http.delete):  # pylint: disable=[invalid-name]
    """
...
get = handlers.http.get  # pylint: disable=[invalid-name]
"""Identical to [`starlite.get`][starlite.handlers.http.get]."""
post = handlers.http.post  # pylint: disable=[invalid-name]
