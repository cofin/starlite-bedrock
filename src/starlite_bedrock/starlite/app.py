...
from starlite_bedrock.starlite import compression, health, hooks, logging, openapi
...
class Starlite(starlite.Starlite):
    ...
    def __init__(
        ...
        *,
        ...
        exception_handlers: dict[int | type[Exception], starlite.types.ExceptionHandler] | None = None,
        ...
        static_files_config: starlite.config.StaticFilesConfig | list[starlite.config.StaticFilesConfig] | None = None,
