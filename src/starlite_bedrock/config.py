...
from starlite_bedrock.cloud.gcp.config import GoogleCloudSettings
...
class Settings(BaseSettings):
    ...
    gcp: GoogleCloudSettings | None
    sentry: SentrySettings | None


@lru_cache(maxsize=1)
def starlite_settings(
    api: APISettings,
    app: AppSettings,
    cache: CacheSettings,
    db: DatabaseSettings,
    ...
    gunicorn: GunicornSettings,
    uvicorn: UvicornSettings,
    gcp: GoogleCloudSettings | None = None,
