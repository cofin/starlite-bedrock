...
class Worker(saq.Worker):  # type: ignore
    ...
    We set [AsyncScopedSession.remove()][starlite.contrib.bedrock.db.AsyncScopedSession] to
...
queue = Queue(redis)
"""
[Queue][starlite.contrib.bedrock.worker.Queue] instance instantiated with [redis][starlite.contrib.bedrock.redis.redis] instance.
"""
